...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query(connection(),"update logindata set nama_pegawai='$nama_pegawai', jabatan='$jabatan', password='$password', username='$username', role='$jabatan' where id_pegawai='$id_pegawai'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Manajemen Pegawai</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span><i class="fa fa-plus-square"></i>&nbsp &nbsp Tambah Pegawai</button>
                                </div>
                                    <div class="table-responsive">
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
                                            ...
                                            <?php
                                                $pgw=mysqli_query(connection(),"SELECT * from logindata");
                                                $no=1;
                                                while($row=mysqli_fetch_array($pgw)){
                                                $idb = $row['id_pegawai'];
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Pegawai <br> <?php echo $row['id_pegawai']?> - <?php echo $row['nama_pegawai']?> - <?php echo $row['jabatan']?></h4>
                                                            ...
                                                            <label for="namid_pegawaia">ID Pegawai</label>
                                                            <input type="number" id="id_pegawai" name="id_pegawai" class="form-control" value="<?php echo $row['id_pegawai'] ?>" disabled>

                                                            <label for="nama_pegawai">Nama Pegawai</label>
                                                            <input type="text" id="nama_pegawai" name="nama_pegawai" class="form-control" value="<?php echo $row['nama_pegawai'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Data Pegawai <br> <?php echo $row['id_pegawai']?> - <?php echo $row['nama_pegawai']?> - <?php echo $row['jabatan']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                    ...
                                    <br><br>
                                    <a href="exportuser.php" target="_blank" class="btn btn-info"><i class="fa fa-print"></i>&nbsp &nbsp Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Pegawai</h4>
						</div>
						<div class="modal-body">
							<form action="tambahuser.php" method="POST">
								<div class="form-group">
									<label>ID Pegawai</label>
									<input name="id_pegawai" type="number" class="form-control" placeholder="ID Pegawai" required>
								</div>
								<div class="form-group">
