                        ...
                        <div class="card">
                            <div class="card-body">
                                <!-- <div class="d-sm-flex justify-content-center align-items-center">
									<h3>Scan QR Code Barang Masuk</h3>
								</div> -->
                                <div class="d-sm-flex justify-content-center align-items-center">
									<video id="preview" width="400px" height="400px"></video>
								</div>
                                <div class="market-status-table mt-4">
                                    <h3><center>Scan QR Code Barang Keluar</center></h3>
                                    <form method="POST">
                                        <div class="form-group">
                                            <input id="qrcode" type="text" class="form-control" style="text-align:center" name="qrcode" placeholder="Kode Barang" disabled>
                                        </div>
                                        <center><input onclick="tampil()" type="button" data-toggle="modal" data-target="#keluar" class="btn btn-info col-md-2" value="Tambahkan"></center>
                                    </form>  
								</div>
                            </div>
                        </div>
                        <div id="keluar" class="modal fade">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="barang_keluar.php" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>Barang</label>
                                                <select id="out" name="barang" class="custom-select form-control" required>
