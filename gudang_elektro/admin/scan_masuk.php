                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <h3><center>Scan QR Code Barang Masuk</center></h3>
                                    <form method="POST">
                                        <div class="form-group">
                                            <input id="qrcode" type="text" class="form-control" style="text-align:center" name="qrcode" placeholder="Kode Barang" disabled>
                                        </div>
                                        <center><input onclick="tampil()" type="button" data-toggle="modal" data-target="#masuk" class="btn btn-info col-md-2" value="Tambahkan"></center>
                                    </form>  
								</div>
                            </div>
                        </div>
                        <div id="masuk" class="modal fade">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="barang_masuk.php" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>Barang</label>
                                                <select id="in" name="barang" class="custom-select form-control" required>
