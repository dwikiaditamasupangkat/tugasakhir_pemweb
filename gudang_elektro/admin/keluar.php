...
<?php 
    ...
    if(isset($_POST['update'])){
        $idkeluar = $_POST['idkeluar']; //iddata
        ...
        $lihatdataskrg = mysqli_query(connection(),"select * from barang_keluar where id_keluar='$idkeluar'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query(connection(),"update stok_barang set jumlah_stok='$kurangistock' where kode_barang='$kodebarang'");
            $updatedata1 = mysqli_query(connection(),"update barang_keluar set tanggal='$tanggal',jumlah='$jumlah',keterangan='$keterangan',penerima='$penerima' where id_keluar='$idkeluar'");
            ...
            $query1 = mysqli_query(connection(),"update stok_barang set jumlah_stok='$tambahistock' where kode_barang='$kodebarang'");

            $updatedata = mysqli_query(connection(),"update barang_keluar set tanggal='$tanggal', jumlah='$jumlah', penerima='$penerima', keterangan='$keterangan' where id_keluar='$idkeluar'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $del = mysqli_query(connection(),"delete from barang_keluar where id_keluar='$idkeluar'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Keluar</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span><i class="fa fa-plus-square"></i>&nbsp &nbsp Tambah Barang Keluar</button>
                                    <a href="scan_keluar.php" class="btn btn-info col-md-2" style="margin-bottom:20px"><span class="glyphicon glyphicon-plus"></span><i class="fa fa-qrcode"></i>&nbsp &nbsp Scan QR Code</a> 
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											<?php 
											$brg=mysqli_query(connection(),"SELECT * from barang_keluar sb, stok_barang st where st.kode_barang=sb.kode_barang order by sb.id_keluar DESC");
											$no=1;
											while($b=mysqli_fetch_array($brg)){
                                                $kodebarang = $b['kode_barang'];
                                                $idkeluar = $b['id_keluar'];
												...
												<tr>
                                                    ...
                                                    <td><button data-toggle="modal" data-target="#edit<?=$idkeluar;?>" class="btn btn-warning">Edit</button> <button data-toggle="modal" data-target="#del<?=$idkeluar;?>" class="btn btn-danger">Del</button></td>
												</tr>
                                                ...
                                                <div class="modal fade" id="edit<?=$idkeluar;?>">
                                                    ...
                                                    <!-- The Modal -->
                                                    <div class="modal fade" id="del<?=$idkeluar;?>">
                                                        <div class="modal-dialog">
                                                        <div class="modal-content">
                                                        <form method="post">
                                                            <!-- Modal Header -->
